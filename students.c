...
void insert(Student *arr, int *n)
{
  ...
  Student student;
  printf("Roll No: "); scanf("%d", &student.roll); getchar();
  printf("Name: "); fgets(student.name, 50, stdin); 
  student.name[strcspn(student.name, "\n")] = '\0';
  char c; while ((c = getchar()) != '\n' && c != EOF);
  printf("Age: "); scanf("%d", &student.age); getchar();
  printf("Gender (M/F): "); student.gender = getchar();
  printf("Mark1 (0-100): "); scanf("%d", &student.mark1);
  printf("Mark2 (0-100): "); scanf("%d", &student.mark2);
  printf("Mark3 (0-100): "); scanf("%d", &student.mark3);
